...
_1579: x0 => x0.createRange(),
_1580: (x0,x1) => x0.selectNode(x1),
_1581: x0 => x0.getSelection(),
_1582: x0 => x0.removeAllRanges(),
_1583: (x0,x1) => x0.addRange(x1),
_1584: (x0,x1) => x0.createElement(x1),
_1585: (x0,x1) => x0.add(x1),
_1586: (x0,x1) => x0.append(x1),
_1587: (x0,x1,x2) => x0.insertRule(x1,x2),
_1588: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1588(f,arguments.length,x0) }),
_1589: (x0,x1) => x0.getItem(x1),
_1591: (x0,x1,x2) => x0.setItem(x1,x2),
_1595: () => globalThis.removeSplashFromWeb(),
_1607: x0 => new Array(x0),
_1641: (decoder, codeUnits) => decoder.decode(codeUnits),
_1642: () => new TextDecoder("utf-8", {fatal: true}),
_1643: () => new TextDecoder("utf-8", {fatal: false}),
_1644: v => v.toString(),
_1645: (d, digits) => d.toFixed(digits),
_1649: x0 => new WeakRef(x0),
_1650: x0 => x0.deref(),
_1656: Date.now,
_1658: s => new Date(s * 1000).getTimezoneOffset() * 60 ,
_1659: s => {
...
_1661: () => typeof dartUseDateNowForTicks !== "undefined",
_1662: () => 1000 * performance.now(),
_1663: () => Date.now(),
_1666: () => new WeakMap(),
_1667: (map, o) => map.get(o),
_1668: (map, o, v) => map.set(o, v),
_1669: () => globalThis.WeakRef,
_1680: s => JSON.stringify(s),
_1681: s => printToConsole(s),
_1682: a => a.join(''),
_1683: (o, a, b) => o.replace(a, b),
_1685: (s, t) => s.split(t),
_1686: s => s.toLowerCase(),
_1687: s => s.toUpperCase(),
_1688: s => s.trim(),
_1689: s => s.trimLeft(),
_1690: s => s.trimRight(),
_1692: (s, p, i) => s.indexOf(p, i),
_1693: (s, p, i) => s.lastIndexOf(p, i),
_1694: (s) => s.replace(/\$/g, "$$$$"),
_1695: Object.is,
_1696: s => s.toUpperCase(),
_1697: s => s.toLowerCase(),
_1698: (a, i) => a.push(i),
_1702: a => a.pop(),
_1703: (a, i) => a.splice(i, 1),
_1705: (a, s) => a.join(s),
_1706: (a, s, e) => a.slice(s, e),
_1709: a => a.length,
_1711: (a, i) => a[i],
_1712: (a, i, v) => a[i] = v,
...
_1726: (t, s) => t.set(s),
_1728: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
_1730: o => o.buffer,
_1731: o => o.byteOffset,
_1732: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
_1733: (b, o) => new DataView(b, o),
_1734: (b, o, l) => new DataView(b, o, l),
_1735: Function.prototype.call.bind(DataView.prototype.getUint8),
_1736: Function.prototype.call.bind(DataView.prototype.setUint8),
_1737: Function.prototype.call.bind(DataView.prototype.getInt8),
_1738: Function.prototype.call.bind(DataView.prototype.setInt8),
_1739: Function.prototype.call.bind(DataView.prototype.getUint16),
_1740: Function.prototype.call.bind(DataView.prototype.setUint16),
_1741: Function.prototype.call.bind(DataView.prototype.getInt16),
_1742: Function.prototype.call.bind(DataView.prototype.setInt16),
_1743: Function.prototype.call.bind(DataView.prototype.getUint32),
_1744: Function.prototype.call.bind(DataView.prototype.setUint32),
_1745: Function.prototype.call.bind(DataView.prototype.getInt32),
_1746: Function.prototype.call.bind(DataView.prototype.setInt32),
_1749: Function.prototype.call.bind(DataView.prototype.getBigInt64),
_1750: Function.prototype.call.bind(DataView.prototype.setBigInt64),
_1751: Function.prototype.call.bind(DataView.prototype.getFloat32),
_1752: Function.prototype.call.bind(DataView.prototype.setFloat32),
_1753: Function.prototype.call.bind(DataView.prototype.getFloat64),
_1754: Function.prototype.call.bind(DataView.prototype.setFloat64),
...
_1879: (o, p) => o[p],
_1880: (o, p, v) => o[p] = v,
_1881: (o, m, a) => o[m].apply(o, a),
_1883: o => String(o),
_1884: (p, s, f) => p.then(s, f),
_1885: s => {
      if (/[[\]{}()*+?.\\^$|]/.test(s)) {
          s = s.replace(/[[\]{}()*+?.\\^$|]/g, '\\$&');
      }
...
_1905: () => globalThis.document,
_1906: () => globalThis.window,
_1911: (x0,x1) => x0.height = x1,
_1913: (x0,x1) => x0.width = x1,
_1917: x0 => x0.head,
_1919: x0 => x0.classList,
_1924: (x0,x1) => x0.innerText = x1,
_1925: x0 => x0.style,
_1926: x0 => x0.sheet,
_1928: x0 => x0.offsetX,
_1929: x0 => x0.offsetY,
